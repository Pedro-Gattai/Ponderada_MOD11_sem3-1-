...
def receive_data():
    try:
        ...
        try:
            ...
            return jsonify({"error": f"Erro ao processar e salvar dados: {e}"}), 500
        ...
        try:
            ...
            return jsonify({"error": f"Erro ao ler arquivo Parquet: {e}"}), 500
        ...
        try:
            ...
            return jsonify({"error": f"Erro ao inserir dados no ClickHouse: {e}"}), 500
